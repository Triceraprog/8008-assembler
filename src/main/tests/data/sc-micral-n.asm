...
;;; Page one has many constants and variables.
	...
	DATA 000,000,000,000	; STORES FLOATING POINT NUMBERNUMBER TEMPORARILLY
	DATA *4
...
SETMCT:    LLI 102                ;Change pointer to bit counter storage location
           LMI 027                ;Initialize bit counter to 23 decimal
                                  ...
                                  ;Next portion of the FPMULT routine is the implemen-
...
SETIT:     LBI 004                ;Set precision counter. Transfer from H & L area to
           JMP MOVEIT             ;Locations pointed to by D & E
                                  ...
                                  ;The next subroutine perforns a double transfer opera-
...
NEXT5:     CAL FSTORE             ;Store the FOR/NEXT LIMIT value
           JMP NEXT6              ;Since have IMPLIED STEP jump ahead
           DCE                    ;When have STEP directive, subtract one from pointer
